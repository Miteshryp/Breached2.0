export default function QuestionCard(props) {
    ...
    return (
        <div className="relative w-full h-fit lg:h-full p-20  rounded-2xl bg-blue-900">
            <div className="h-full p-4 my-10 lg:my-0 flex flex-col lg:flex-row justify-start lg:justify-center gap-10 lg:gap-5">
                <div className="w-full lg:w-7/12 h-auto flex flex-col gap-4 lg:justify-start">
                    ...
                    <div className="w-full h-fit lg:h-[80%] lg:overflow-y-auto lg:scrollbar lg:scrollbar-thumb-gray-400 scrollbar-thumb-rounded-full">
            ...
            <div className="w-full h-fit flex flex-col lg:flex-row justify-center items-center lg:justify-start lg:items-start">
                <form className="h-fit flex flex-col justify-center items-center lg:flex-row lg:justify-start lg:items-start">
                    <input className="w-full lg:w-80 h-14 p-2 lg:h-14 mx-6 rounded text-center" type="text" />
                    <input className="w-full lg:w-40 p-4 my-4 lg:my-0 h-full rounded-xl bg-sky-400 text-center transition-all hover:scale-110 hover:text-white" type="button" value="Submit" />
